...
echo "======================> cleaning sym link %GOPATH%\src\github.com\StackVista\stackstate-agent"
REM if exist %GOPATH%\src\github.com\StackVista\stackstate-agent rd /s/q %GOPATH%\src\github.com\StackVista\stackstate-agent
if exist %GOPATH%\src\github.com\StackVista\stackstate-agent junction -d "%GOPATH%\src\github.com\StackVista\stackstate-agent"
mkdir -p c:\gopath\src\github.com\StackVista\
rd /s/q %GOPATH%\src\github.com\StackVista\stackstate-agent
