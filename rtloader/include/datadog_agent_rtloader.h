...
/*! \fn void set_set_transaction_state_cb(rtloader_t *, cb_set_transaction_state_t)
    ...
    The callback is expected to be provided by the rtloader caller - in go-context: CGO.
*/
DATADOG_AGENT_RTLOADER_API void set_set_transaction_state_cb(rtloader_t *, cb_set_transaction_state_t);


/*! \fn void set_set_state_cb(rtloader_t *, cb_set_state_t)
    ...
    The callback is expected to be provided by the rtloader caller - in go-context: CGO.
*/
DATADOG_AGENT_RTLOADER_API void set_set_state_cb(rtloader_t *, cb_set_state_t);
