...
$ conda activate ddpy3 && \
  inv deps && \
  inv agent.clean && \
  inv -e omnibus.build --base-dir /omnibus --skip-deps --skip-sign --major-version 3 --python-runtimes 3
```
...
$ conda activate ddpy2 && \
  inv deps && \
  inv agent.clean && \
  inv -e omnibus.build --base-dir /omnibus --skip-deps --skip-sign --major-version 2 --python-runtimes 2
```
