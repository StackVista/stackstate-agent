...
def apply_branding(ctx):
    ...
    do_sed_rename(ctx, 's/Data[dD]og/StackState/', "./omnibus/resources/agent/msi/cal/CustomAction.cpp")
    do_sed_rename(ctx, 's/datadog/stackstate/', "./omnibus/resources/agent/msi/cal/CustomAction.cpp")
    do_sed_rename(ctx, 's/Data[dD]og/StackState/', "./omnibus/resources/agent/msi/cal/CustomAction.def")
    do_sed_rename(ctx, 's/Data[dD]og/StackState/', "./omnibus/resources/agent/msi/localization-en-us.wxl.erb")
    ...
    do_sed_rename(ctx, 's/Data[dD]og/StackState/', "./omnibus/resources/agent/msi/source.wxs.erb")
