...
# @task
# def revert_branding(ctx):
#     """
#     Apply datadog branding (revert stackstate branding)
#     """
#     sts_camel_replace = 's/StackState/Data[dD]og/g'
#     sts_lower_replace = 's/stackstate/datadog/g'
#
#     # Config
#     do_go_rename(ctx, '"\\"sts_url\\" -> \\"dd_url\\""', "./pkg/config")
#     do_go_rename(ctx, '"\\"http://localhost:7077\\" -> \\"https://app.datadoghq.com\\""', "./pkg/config")
#     do_go_rename(ctx, '"\\"STS_PROXY_HTTP\\" -> \\"DD_PROXY_HTTP\\""', "./pkg/config")
#     do_go_rename(ctx, '"\\"STS_PROXY_HTTPS\\" -> \\"DD_PROXY_HTTPS\\""', "./pkg/config")
#     do_go_rename(ctx, '"\\"STS_PROXY_NO_PROXY\\" -> \\"DD_PROXY_NO_PROXY\\""', "./pkg/config")
#     do_go_rename(ctx, '"\\"DOCKER_STS_AGENT\\" -> \\"DOCKER_DD_AGENT\\""', "./pkg/config")
#     do_go_rename(ctx, '"\\"STS\\" -> \\"DD\\""', "./pkg/config")
#     do_go_rename(ctx, '"\\"stackstate\\" -> \\"datadog\\""', "./pkg/config")
#     do_go_rename(ctx, '"\\"/etc/stackstate-agent/conf.d\\" -> \\"/etc/datadog-agent/conf.d\\""', "./pkg/config")
#     do_go_rename(ctx, '"\\"/etc/stackstate-agent/checks.d\\" -> \\"/etc/datadog-agent/checks.d\\""', "./pkg/config")
#     do_go_rename(ctx, '"\\"/opt/stackstate-agent/run\\" -> \\"/opt/datadog-agent/run\\""', "./pkg/config")
#
#     # Trace agent
#     do_go_rename(ctx, '"\\"STS_PROXY_HTTPS\\" -> \\"DD_PROXY_HTTPS\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_CONNECTION_LIMIT\\" -> \\"DD_CONNECTION_LIMIT\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_APM_CONNECTION_LIMIT\\" -> \\"DD_APM_CONNECTION_LIMIT\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_RECEIVER_PORT\\" -> \\"DD_RECEIVER_PORT\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_APM_RECEIVER_PORT\\" -> \\"DD_APM_RECEIVER_PORT\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_MAX_EPS\\" -> \\"DD_MAX_EPS\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_MAX_TPS\\" -> \\"DD_MAX_TPS\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_APM_MAX_TPS\\" -> \\"DD_APM_MAX_TPS\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_IGNORE_RESOURCE\\" -> \\"DD_IGNORE_RESOURCE\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_APM_IGNORE_RESOURCES\\" -> \\"DD_APM_IGNORE_RESOURCES\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_API_KEY\\" -> \\"DD_API_KEY\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_SITE\\" -> \\"DD_SITE\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_APM_ENABLED\\" -> \\"DD_APM_ENABLED\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_APM_URL\\" -> \\"DD_APM_DD_URL\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_HOSTNAME\\" -> \\"DD_HOSTNAME\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_BIND_HOST\\" -> \\"DD_BIND_HOST\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_DOGSTATSD_PORT\\" -> \\"DD_DOGSTATSD_PORT\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_APM_NON_LOCAL_TRAFFIC\\" -> \\"DD_APM_NON_LOCAL_TRAFFIC\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_LOG_LEVEL\\" -> \\"DD_LOG_LEVEL\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_APM_ANALYZED_SPANS\\" -> \\"DD_APM_ANALYZED_SPANS\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_APM_MAX_EPS\\" -> \\"DD_APM_MAX_EPS\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_APM_ENV\\" -> \\"DD_APM_ENV\\""', "./pkg/trace")
#     do_go_rename(ctx, '"\\"STS_APM_MAX_MEMORY\\" -> \\"DD_APM_MAX_MEMORY\\""', "./pkg/trace")
#
#     do_go_rename(ctx, '"\\"/var/log/stackstate-agent/trace-agent.log\\" -> \\"/var/log/datadog/trace-agent.log\\""', "./pkg/trace/config/")
#     do_go_rename(ctx, '"\\"/opt/stackstate-agent/embedded/bin/python\\" -> \\"/opt/datadog-agent/embedded/bin/python\\""', "./pkg/trace/config/")
#     do_go_rename(ctx, '"\\"PYTHONPATH=/opt/stackstate-agent/agent\\" -> \\"PYTHONPATH=/opt/datadog-agent/agent\\""', "./pkg/trace/config/")
#     do_go_rename(ctx, '"\\"/var/log/stackstate/agent.log\\" -> \\"/var/log/datadog/agent.log\\""', "./pkg/trace/config/")
#     do_go_rename(ctx, '"\\"/opt/stackstate-agent/bin/agent/agent\\" -> \\"/opt/datadog-agent/bin/agent/agent\\""', "./pkg/trace/config/")
#     do_go_rename(ctx, '"\\"/etc/sts-agent/stackstate.conf\\" -> \\"/etc/dd-agent/datadog.conf\\""', "./pkg/trace/config/")
#
#     do_go_rename(ctx, '"\\"Stackstate Trace Agent\\" -> \\"Datadog Trace Agent\\""', "./pkg/trace/writer/")
#     do_go_rename(ctx, '"\\"https://github.com/Stackvista/stackstate-trace-agent\\" -> \\"https://github.com/DataDog/datadog-trace-agent\\""', "./pkg/trace/writer/")
#
#     # Trace agent
#     apm_dd_url_replace = 's/apm_sts_url/apm_dd_url/g'
#     do_sed_rename(ctx, apm_dd_url_replace, "./pkg/trace/config/apply.go")
#     do_sed_rename(ctx, apm_dd_url_replace, "./pkg/trace/config/env.go")
#     do_sed_rename(ctx, 's/STS_APM_ENABLED/DD_APM_ENABLED/g', "./pkg/trace/agent/run.go")
#     dd_agent_bin_replace = 's/sts_agent_bin/dd_agent_bin/g'
#     do_sed_rename(ctx, dd_agent_bin_replace, "./pkg/trace/config/apply.go")
#     DD_API_KEY_replace = 's/STS_API_KEY/DD_API_KEY/g'
#     do_sed_rename(ctx, DD_API_KEY_replace, "./pkg/trace/config/config.go")
#     DD_HOSTNAME_replace = 's/STS_HOSTNAME/DD_HOSTNAME/g'
#     do_sed_rename(ctx, DD_HOSTNAME_replace, "./pkg/trace/config/config.go")
#
#     # Cluster agent
#     cluster_agent_replace = '/www/! s/stackstate/datadog/g'
#     do_sed_rename(ctx, cluster_agent_replace, "./cmd/cluster-agent/main.go")
#     do_sed_rename(ctx, cluster_agent_replace, "./cmd/cluster-agent/app/*")
#     do_sed_rename(ctx, 's/StackState Cluster/Datadog Cluster/g', "./cmd/cluster-agent/app/*")
#     do_sed_rename(ctx, 's/StackState Agent/Datadog Agent/g', "./cmd/cluster-agent/app/*")
#     do_sed_rename(ctx, 's/to StackState/to Datadog/g', "./cmd/cluster-agent/app/*")
#
#     # Defaults
#     do_go_rename(ctx, '"\\"/etc/stackstate-agent\\" -> \\"/etc/datadog-agent\\""', "./cmd/agent/common")
#     do_go_rename(ctx, '"\\"/var/log/stackstate-agent/agent.log\\" -> \\"/var/log/datadog/agent.log\\""', "./cmd/agent/common")
#     do_go_rename(ctx, '"\\"/var/log/stackstate-agent/cluster-agent.log\\" -> \\"/var/log/datadog/cluster-agent.log\\""', "./cmd/agent/common")
#     do_go_rename(ctx, '"\\"stackstate.yaml\\" -> \\"datadog.yaml\\""', "./cmd/agent")
#     do_go_rename(ctx, '"\\"stackstate.conf\\" -> \\"datadog.conf\\""', "./cmd/agent")
#     do_go_rename(ctx, '"\\"path to directory containing stackstate.yaml\\" -> \\"path to directory containing datadog.yaml\\""', "./cmd")
#     do_go_rename(ctx, '"\\"unable to load StackState config file: %s\\" -> \\"unable to load Datadog config file: %s\\""', "./cmd/agent/common")
#     do_go_rename(ctx, '"\\"Starting StackState Agent v%v\\" -> \\"Starting Datadog Agent v%v\\""', "./cmd/agent/app")
#
#     # Dist config templates
#     do_sed_rename(ctx, sts_lower_replace, "./cmd/agent/dist/conf.d/go_expvar.d/agent_stats.yaml.example")
#     do_sed_rename(ctx, sts_lower_replace, "./cmd/agent/dist/conf.d/apm.yaml.default")
#     do_sed_rename(ctx, 's/sts/dd/g', "./cmd/agent/dist/dd-agent")
#     do_sed_rename(ctx, sts_lower_replace, "./cmd/agent/dist/dd-agent")
#
#     # Hardcoded checks and metrics
#     do_sed_rename(ctx, sts_lower_replace, "./pkg/aggregator/aggregator.go")
...
#     do_sed_rename(ctx, sts_lower_replace, "./cmd/agent/app/dependent_services_windows.go")
#     # replace strings NOT containing certain pattern
#     do_sed_rename(ctx, '/config/! s/StackState/Data[dD]og/g', "./cmd/agent/common/common_windows.go")
#     do_sed_rename(ctx, sts_lower_replace, "./cmd/agent/common/common_windows.go")
#     do_sed_rename(ctx, 's/sts_url/dd_url/', "./cmd/agent/common/common_windows.go")
#     do_sed_rename(ctx, sts_lower_replace, "./cmd/dogstatsd/main_windows.go")
#     do_sed_rename(ctx, sts_camel_replace, "./pkg/config/config_windows.go")
#
#     # Windows MSI installation
...
#     do_sed_rename(ctx, sts_camel_replace, "./omnibus/resources/agent/msi/cal/CustomAction.def")
#     do_sed_rename(ctx, sts_camel_replace, "./omnibus/resources/agent/msi/localization-en-us.wxl.erb")
#     do_sed_rename(ctx, 's/"stackstate\.yaml\.example"/"datadog\.yaml\.example"/', "./omnibus/resources/agent/msi/source.wxs.erb")
#     do_sed_rename(ctx, 's/stackstate\.com/www\.datadoghq\.com/', "./omnibus/resources/agent/msi/source.wxs.erb")
#     do_sed_rename(ctx, sts_camel_replace, "./omnibus/resources/agent/msi/source.wxs.erb")
#     do_sed_rename(ctx, sts_lower_replace, "./omnibus/resources/agent/msi/source.wxs.erb")
#     do_sed_rename(ctx, 's/STACKSTATE/DATADOG/', "./omnibus/resources/agent/msi/source.wxs.erb")
#     do_sed_rename(ctx, 's/sts_url/dd_url/', "./omnibus/resources/agent/msi/source.wxs.erb")
#     do_sed_rename(ctx, 's/\[.*STS_URL\]/\[DD_URL\]/', "./omnibus/resources/agent/msi/source.wxs.erb")
#     do_sed_rename(ctx, sts_camel_replace, "./omnibus/resources/agent/msi/bundle.wxs.erb")
#     do_sed_rename(ctx, 's/sts_logo_side\\.png/dd_logo_side\\.png/', "./omnibus/resources/agent/msi/bundle.wxs.erb")
#
#     # Windows SysTray and GUI
#     tray_replace = 's/ststray/ddtray/'
#     do_sed_rename(ctx, sts_lower_replace, "./cmd/systray/doservicecontrol.go")
#     do_sed_rename(ctx, sts_camel_replace, "./cmd/systray/systray.go")
#     do_sed_rename(ctx, tray_replace, "./cmd/systray/systray.go")
#     do_sed_rename(ctx, sts_camel_replace, "./cmd/systray/systray.rc")
...
#     do_sed_rename(ctx, tray_replace, "./tasks/systray.py")
#     do_sed_rename(ctx, sts_lower_replace, "./cmd/agent/gui/views/templates/index.tmpl")
#     do_sed_rename(ctx, 's/"StackState Agent 2"/"DataDog Agent 6"/', "./cmd/agent/gui/views/templates/index.tmpl")
#     do_sed_rename(ctx, sts_camel_replace, "./cmd/agent/gui/views/templates/index.tmpl")
#     do_sed_rename(ctx, sts_camel_replace, "./cmd/agent/gui/views/private/js/javascript.js")
#
#     # stackstate_checks
#     do_go_rename(ctx, '"\\"stackstate_checks\\" -> \\"datadog_checks\\""', "./cmd/agent/app")
#     do_sed_rename(ctx, 's/stackstate_checks_base/datadog_checks_base/g', "cmd/agent/app/integrations.go")
#     do_go_rename(ctx, '"\\"stackstate_checks\\" -> \\"datadog_checks\\""', "./pkg/collector/py")
