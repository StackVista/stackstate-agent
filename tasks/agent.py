...
def apply_branding(ctx):
    ...
    sts_win_programdata_replace = 's/"programdata\\\\\\\\\\\\\\\\datadog"/"programdata\\\\\\\\\\\\\\\\stackstate"/g'
    sts_win_programdata_camel_replace = 's/"ProgramData\\\\\\\\\\\\\\\\datadog"/"ProgramData\\\\\\\\\\\\\\\\StackState"/g'
    sts_win_programdata_camel2_replace = 's/"ProgramData\\\\\\\\\\\\\\\\DataDog"/"ProgramData\\\\\\\\\\\\\\\\StackState"/g'
    sts_win_stackvista_replace = 's/"\\\\\\\\\\\\\\\\StackState\\\\\\\\\\\\\\\\StackVista"/"\\\\\\\\\\\\\\\\StackState\\\\\\\\\\\\\\\\StackState Agent"/g'
    ...
    do_sed_rename(ctx, sts_win_programdata_replace,
                  "./cmd/agent/common/common_windows.go")
    do_sed_rename(ctx, sts_win_programdata_camel_replace,
                  "./cmd/agent/common/common_windows.go")
    do_sed_rename(ctx, 's/"Datadog"/"StackState"/g',
                  "./cmd/agent/common/common_windows.go")
    do_sed_rename(ctx, sts_win_programdata_camel2_replace,
                  "./cmd/agent/common/common_windows.go")
    ...
    do_sed_rename(ctx, 's/"\\StackState\\StackVista"/"\\StackState\\StackState Agent"/g',
                  "./tools/windows/install-help/cal/stringtable.rc")
    do_sed_rename(ctx, sts_win_stackvista_replace,
                  "./tools/windows/install-help/cal/stringtable.rc")
    do_sed_rename(ctx, 's/datadog/stackstate/g',
                  "./cmd/agent/common/common_windows.go")
    ...
    do_go_rename(ctx, '"\\"unable to load Datadog config file:\\" -> \\"unable to load StackState config file:\\""', "./cmd/agent/common")
    ...
    do_sed_rename(ctx, sts_lower_replace, "./cmd/process-agent/flags/flags_windows.go")
    do_sed_rename(ctx, sts_camel_replace, "./pkg/config/config_windows.go")
    do_sed_rename(ctx, sts_lower_replace, "./pkg/config/config_windows.go")
    do_sed_rename(ctx, sts_camel_replace, "./tools/windows/install-help/install-cmd/cmdline.cpp")
    do_sed_rename(ctx, sts_camel_replace, "./Dockerfiles/agent/windows/entrypoint/entrypoint.cpp")
    do_sed_rename(ctx, sts_lower_replace, "./Dockerfiles/agent/windows/entrypoint/entrypoint.cpp")
    do_sed_rename(ctx, sts_lower_replace, "./Dockerfiles/agent/windows/entrypoint/entrypoint.cpp")
