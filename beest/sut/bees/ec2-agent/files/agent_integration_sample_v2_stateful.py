...
from stackstate_checks.base.checks.v2.stateful_agent_check import AgentCheckV2, StatefulAgentCheck
...
class AgentIntegrationSampleStatefulCheck(StatefulAgentCheck):
    ...
    def get_instance_key(self, instance):
        return StackPackInstance("agent-v2-integration-stateful", "sample")
