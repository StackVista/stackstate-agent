...
func getLocalIntegrationConfigs(senderManager diagnosesendermanager.Component,
	...
	pkgcollector.InitCheckScheduler(option.None[collector.Component](), senderManagerInstance, handler.NewMockCheckManager(), option.None[integrations.Component](), tagger)
