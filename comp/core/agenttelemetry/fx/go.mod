...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/agenttelemetry/impl v0.78.3-rc.2
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/fleet/installer v0.78.3-rc.2 // indirect
	github.com/DataDog/datadog-agent/pkg/gohai v0.78.3-rc.2 // indirect
	...
	github.com/DataDog/datadog-agent/pkg/util/hostinfo v0.78.3-rc.2 // indirect
	...
	github.com/DataDog/datadog-agent/pkg/util/uuid v0.78.3-rc.2 // indirect
