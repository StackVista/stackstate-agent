...
// Source: /home/bob/dev/go/src/github.com/DataDog/datadog-agent/pkg/proto/pbgo/api.pb.go
...
func (m *MockAgentSecureClient) GetConfigUpdates(ctx context.Context, in *pbgo.SubscribeConfigRequest, opts ...grpc.CallOption) (pbgo.AgentSecure_GetConfigUpdatesClient, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (mr *MockAgentSecureClientMockRecorder) GetConfigUpdates(ctx, in interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, in}, opts...)
...
// GetConfigUpdates mocks base method.
func (m *MockAgentSecureServer) GetConfigUpdates(arg0 *pbgo.SubscribeConfigRequest, arg1 pbgo.AgentSecure_GetConfigUpdatesServer) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetConfigUpdates", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// GetConfigUpdates indicates an expected call of GetConfigUpdates.
func (mr *MockAgentSecureServerMockRecorder) GetConfigUpdates(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetConfigUpdates", reflect.TypeOf((*MockAgentSecureServer)(nil).GetConfigUpdates), arg0, arg1)
}
