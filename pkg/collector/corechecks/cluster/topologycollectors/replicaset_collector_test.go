...
func TestReplicaSetCollector(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			expectedComponent: &topology.Component{
				ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:replicaset:test-replicaset-1",
		...
		},
		{
			...
			expectedComponent: &topology.Component{
				ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:replicaset:test-replicaset-2",
				Type:       topology.Type{Name: "replicaset"},
				Data: topology.Data{
		...
		},
		{
			...
			expectedComponent: &topology.Component{
				ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:replicaset:test-replicaset-3",
				Type:       topology.Type{Name: "replicaset"},
				Data: topology.Data{
			...
			expectedRelations: []*topology.Relation{
				{
					ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:deployment:test-deployment-3->" +
						"urn:/kubernetes:test-cluster-name:namespace:test-namespace:replicaset:test-replicaset-3",
					Type:     topology.Type{Name: "controls"},
					SourceID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:deployment:test-deployment-3",
					TargetID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:replicaset:test-replicaset-3",
