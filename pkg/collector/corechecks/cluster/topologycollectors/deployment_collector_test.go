...
func TestDeploymentCollector(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			expected: &topology.Component{
				ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:deployment:test-deployment-1",
		...
		},
		{
			...
			expected: &topology.Component{
				ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:deployment:test-deployment-2",
				Type:       topology.Type{Name: "deployment"},
				Data: topology.Data{
