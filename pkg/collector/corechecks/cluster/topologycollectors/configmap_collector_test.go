...
func TestConfigMapCollector(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			expected: &topology.Component{
				ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:configmap:test-configmap-1",
				...
				Data: topology.Data{
					...
					"identifiers":       []string{"urn:/kubernetes:test-cluster-name:namespace:test-namespace:configmap:test-configmap-1"},
				},
			},
		},
		{
			...
			expected: &topology.Component{
				ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:configmap:test-configmap-2",
				Type:       topology.Type{Name: "configmap"},
				Data: topology.Data{
					...
					"identifiers":       []string{"urn:/kubernetes:test-cluster-name:namespace:test-namespace:configmap:test-configmap-2"},
				},
			},
		},
		{
			...
			expected: &topology.Component{
				ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:configmap:test-configmap-3",
				Type:       topology.Type{Name: "configmap"},
				Data: topology.Data{
					...
					"identifiers":       []string{"urn:/kubernetes:test-cluster-name:namespace:test-namespace:configmap:test-configmap-3"},
				},
			},
		},
	} {
