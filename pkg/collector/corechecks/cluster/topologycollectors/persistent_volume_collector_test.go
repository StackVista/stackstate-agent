...
func TestPersistentVolumeCollector(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			expected: &topology.Component{
				ExternalID: "urn:kubernetes:/test-cluster-name:test-namespace:persistent-volume/test-persistent-volume-1",
		...
		},
		{
			...
			expected: &topology.Component{
				ExternalID: "urn:kubernetes:/test-cluster-name:test-namespace:persistent-volume/test-persistent-volume-2",
				Type:       topology.Type{Name: "persistent-volume"},
				Data: topology.Data{
		...
		},
		{
			...
			expected: &topology.Component{
				ExternalID: "urn:kubernetes:/test-cluster-name:test-namespace:persistent-volume/test-persistent-volume-3",
				Type:       topology.Type{Name: "persistent-volume"},
				Data: topology.Data{
