...
func TestPersistentVolumeCollectorCSIVolumeMapperEnabled(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		t.Run(testCaseName(tc.testCase), func(t *testing.T) {
			cmc := NewPersistentVolumeCollector(NewTestCommonClusterCollector(tc.apiCollectorClientFactory(), componentChannel, relationChannel), true)
...
func TestPersistentVolumeCollectorCSIVolumeMapperDisabled(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		t.Run(testCaseName(tc.testCase), func(t *testing.T) {
			cmc := NewPersistentVolumeCollector(NewTestCommonClusterCollector(tc.apiCollectorClientFactory(), componentChannel, relationChannel), false)
			expectedCollectorName := "Persistent Volume Collector"
			RunCollectorTest(t, cmc, expectedCollectorName)
...
func TestPersistentVolumeCollectorVolumeAttachmentToNodeRelation(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		t.Run(testCaseName(tc.testCase), func(t *testing.T) {
			commonClusterCollector := NewTestCommonClusterCollector(tc.apiCollectorClientFactory(), componentChannel, relationChannel)
