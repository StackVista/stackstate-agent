...
func TestIngressCollector_1_18(t *testing.T) {
	...
	commonClusterCollector := NewTestCommonClusterCollectorWithVersion(MockIngressAPICollectorClient{}, componentChannel, relationChannel, &k8sVersion)
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			assertions: []func(*testing.T, chan *topology.Component, chan *topology.Relation){
				expectIngress211(creationTimeFormatted),
				expectEndpoint211(),
		...
		},
		{
			...
			assertions: []func(*testing.T, chan *topology.Component, chan *topology.Relation){
				expectIngress212(creationTimeFormatted),
		...
		},
		{
			...
			assertions: []func(*testing.T, chan *topology.Component, chan *topology.Relation){
				expectIngress213(creationTimeFormatted),
...
func TestIngressCollector_1_22(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			testCase: "Test Service 1 - Minimal",
			assertions: []func(*testing.T, chan *topology.Component, chan *topology.Relation){
				expectIngress221(creationTimeFormatted),
				expectEndpointIP221(),
		...
		},
		{
			testCase: "Test Service 2 - Default Backend",
			assertions: []func(*testing.T, chan *topology.Component, chan *topology.Relation){
				expectIngress222(creationTimeFormatted),
		...
		},
		{
			testCase: "Test Service 3 - Ingress Rules",
			assertions: []func(*testing.T, chan *topology.Component, chan *topology.Relation){
				expectIngress223(creationTimeFormatted),
...
func expectIngress213(creationTimeFormatted string) func(*testing.T, chan *topology.Component, chan *topology.Relation) {
...
func expectIngress212(creationTimeFormatted string) func(*testing.T, chan *topology.Component, chan *topology.Relation) {
	return expectComponent(
		&topology.Component{
			ExternalID: "urn:kubernetes:/test-cluster-name:test-namespace:ingress/test-ingress-2",
			Type:       topology.Type{Name: "ingress"},
...
func expectIngress211(creationTimeFormatted string) func(*testing.T, chan *topology.Component, chan *topology.Relation) {
	return expectComponent(
		&topology.Component{
...
func expectIngress223(creationTimeFormatted string) func(*testing.T, chan *topology.Component, chan *topology.Relation) {
	return expectComponent(
		&topology.Component{
			ExternalID: "urn:kubernetes:/test-cluster-name:test-namespace:ingress/test-ingress22-3",
			Type:       topology.Type{Name: "ingress"},
...
func expectIngress222(creationTimeFormatted string) func(*testing.T, chan *topology.Component, chan *topology.Relation) {
	return expectComponent(
		&topology.Component{
			ExternalID: "urn:kubernetes:/test-cluster-name:test-namespace:ingress/test-ingress22-2",
			Type:       topology.Type{Name: "ingress"},
...
func expectIngress221(creationTimeFormatted string) func(*testing.T, chan *topology.Component, chan *topology.Relation) {
	return expectComponent(
		&topology.Component{
...
func TestIngressCollector_NoHttpRule(t *testing.T) {
	...
	commonClusterCollector := NewTestCommonClusterCollectorWithVersion(MockIngressAPICollectorClientNoHTTPRule{}, componentChannel, relationChannel, &versionInfo)
	commonClusterCollector.SetUseRelationCache(false)
	ic := NewIngressCollector(commonClusterCollector)
	expectedCollectorName := "Ingress Collector"
	RunCollectorTest(t, ic, expectedCollectorName)
