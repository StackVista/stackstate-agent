...
func TestStatefulSetCollector(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			expected: &topology.Component{
				ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:statefulset:test-statefulset-1",
		...
		},
		{
			...
			expected: &topology.Component{
				ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:statefulset:test-statefulset-2",
				Type:       topology.Type{Name: "statefulset"},
				Data: topology.Data{
		...
		},
		{
			...
			expected: &topology.Component{
				ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:statefulset:test-statefulset-3",
				Type:       topology.Type{Name: "statefulset"},
				Data: topology.Data{
