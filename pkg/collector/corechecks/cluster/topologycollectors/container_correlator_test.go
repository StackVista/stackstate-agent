...
func TestContainerCollector(t *testing.T) {
	...
	commonClusterCorrelator := NewClusterTopologyCorrelator(NewTestCommonClusterCollector(MockContainerAPICollectorClient{}, componentChannel, relationChannel, false, false))
