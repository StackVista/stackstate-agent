...
func TestDaemonSetCollector(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			expected: &topology.Component{
				ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:daemonset:test-daemonset-1",
		...
		},
		{
			...
			expected: &topology.Component{
				ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:daemonset:test-daemonset-2",
				Type:       topology.Type{Name: "daemonset"},
				Data: topology.Data{
		...
		},
		{
			...
			expected: &topology.Component{
				ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:daemonset:test-daemonset-3",
				Type:       topology.Type{Name: "daemonset"},
				Data: topology.Data{
