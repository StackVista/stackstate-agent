...
func TestJobCollector(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			expectedComponent: &topology.Component{
				ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:job:test-job-1",
			...
			expectedRelations: []*topology.Relation{
				{
					ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:cronjob:test-cronjob-1->" +
						"urn:/kubernetes:test-cluster-name:namespace:test-namespace:job:test-job-1",
					Type:     topology.Type{Name: "creates"},
					SourceID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:cronjob:test-cronjob-1",
					TargetID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:job:test-job-1",
		...
		},
		{
			testCase: "Test Job 2",
			expectedComponent: &topology.Component{
				ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:job:test-job-2",
				Type:       topology.Type{Name: "job"},
				Data: topology.Data{
					"name":              "test-job-2",
					"creationTimestamp": creationTime,
		...
		},
		{
			...
			expectedComponent: &topology.Component{
				ExternalID: "urn:/kubernetes:test-cluster-name:namespace:test-namespace:job:test-job-3",
				Type:       topology.Type{Name: "job"},
				Data: topology.Data{
					"name":              "test-job-3",
					"creationTimestamp": creationTime,
