...
const (
	KubernetesAPITopologyCheckName = "kubernetes_api_topology" // TODO: Refactor to CheckName
)
...
func (t *TopologyCheck) Run() error {
	...
	clusterTopologyCommon := collectors.NewClusterTopologyCommon(
		t.instance.Instance,
		instanceClusterType,
		t.ac,
		componentChannel,
		relationChannel,
		t.getKubernetesVersion(),
	)
...
func KubernetesAPITopologyFactory() option.Option[func() check.Check] {
