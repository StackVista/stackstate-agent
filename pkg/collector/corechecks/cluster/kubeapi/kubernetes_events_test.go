...
func createEvent(count int32, namespace, objname, objkind, objuid, component, hostname, reason string, message string, firsttimestamp int64, lasttimestamp int64, alertType string) *v1.Event {
	return &v1.Event{
