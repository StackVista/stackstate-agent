...
func TestDiskCheck(t *testing.T) {
	...
	diskCheck.Configure(mock.GetSenderManager(), checkManager, integration.FakeConfigHash, nil, nil, "test", "provider")
...
func TestDiskCheckWithoutCoreLoader(t *testing.T) {
	...
	diskCheck := new(Check)
	mock := mocksender.NewMockSender(diskCheck.ID())
	err := diskCheck.Configure(mock.GetSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, nil, nil, "test", "provider")
...
func TestDiskCheckExcludedDiskFilsystem(t *testing.T) {
	...
	diskCheck := new(Check)
	mock := mocksender.NewMockSender(diskCheck.ID())
	diskCheck.Configure(mock.GetSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, nil, nil, "test", "provider")
...
func TestDiskCheckTags(t *testing.T) {
	...
	mock := mocksender.NewMockSender(diskCheck.ID())
	diskCheck.Configure(mock.GetSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, config, nil, "test", "provider")
	_ = batcher.NewMockBatcher()
