...
func (c *IOCheck) commonConfigure(senderManager sender.SenderManager, checkManager handler.CheckManager, data integration.Data, initConfig integration.Data, source string, provider string) error {
