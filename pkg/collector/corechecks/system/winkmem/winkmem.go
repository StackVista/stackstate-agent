...
func (w *KMemCheck) Configure(senderManager sender.SenderManager, checkManager handler.CheckManager, integrationConfigDigest uint64, data integration.Data, initConfig integration.Data, source string) error {
	...
	if err := w.CommonConfigure(senderManager, checkManager, integrationConfigDigest, initConfig, data, source); err != nil {
		return err
	}
	cf := Config{
