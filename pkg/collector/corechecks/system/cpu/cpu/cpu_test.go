...
func TestCPUCheckLinuxErrorInInstanceConfig(t *testing.T) {
	...
	err := cpuCheck.Configure(m.GetSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, []byte(`min_collection_interval: "string_value"`), integration.Data{}, "test")
...
func TestCPUCheckLinuxErrorReportTotalPerCPUConfigNotBoolean(t *testing.T) {
	...
	err := cpuCheck.Configure(m.GetSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, []byte(`report_total_percpu: "string_value"`), integration.Data{}, "test")
...
func TestCPUCheckLinuxErrorStoppedSender(t *testing.T) {
	...
	cpuCheck.Configure(m.GetSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, integration.Data{}, integration.Data{}, "test")
...
func TestSystemCpuMetricsPerCpuError(t *testing.T) {
	...
	cpuCheck.Configure(m.GetSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, []byte(`report_total_percpu: true`), integration.Data{}, "test")
	err := cpuCheck.Run()
...
func TestSystemCpuMetricsPerCpuFalse(t *testing.T) {
	...
	cpuCheck.Configure(m.GetSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, []byte(`report_total_percpu: false`), integration.Data{}, "test")
	err := cpuCheck.Run()
