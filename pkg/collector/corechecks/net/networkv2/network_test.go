...
func TestDefaultConfiguration(t *testing.T) {
	...
	check.Configure(aggregator.NewNoOpSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, integration.Data{}, integration.Data{}, "test")
...
`)
	err := check.Configure(aggregator.NewNoOpSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, rawInstanceConfig, integration.Data{}, "test")
...
`)
	...
	err := networkCheck.Configure(mockSender.GetSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, rawInstanceConfig, integration.Data{}, "test")
	assert.Nil(t, err)
...
`)
	...
	mockSender := mocksender.NewMockSender(networkCheck.ID())
	networkCheck.Configure(mockSender.GetSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, rawInstanceConfig, integration.Data{}, "test")
...
func TestFetchEthtoolStats(t *testing.T) {
	...
	mockSender := mocksender.NewMockSender(networkCheck.ID())
	networkCheck.Configure(mockSender.GetSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, integration.Data(`collect_ethtool_metrics: true`), integration.Data{}, "test")
...
collect_connection_queues: true`)
	mockSender := mocksender.NewMockSender(networkCheck.ID())
	networkCheck.Configure(mockSender.GetSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, fakeInstanceConfig, integration.Data{}, "test")
