...
unit_names:
 ...
 - syslog.socket
`)
	err := check.Configure(aggregator.NewNoOpSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, rawInstanceConfig, []byte(``), "test", "provider")
...
func TestMissingUnitNamesOrRegexShouldRaiseError(t *testing.T) {
	check := SystemdCheck{}
	err := check.Configure(aggregator.NewNoOpSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, []byte(``), []byte(``), "test", "provider")
...
unit_regexes:
  - "+"
`)
	err := check.Configure(aggregator.NewNoOpSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, integration.Data(rawInstanceConfig), integration.Data{}, "test", "provider")
...
`)
	...
	check.Configure(senderManager, handler.NewMockCheckManager(), integration.FakeConfigHash, rawInstanceConfig, []byte(``), "test", "provider")
...
func TestDbusConnectionErr(t *testing.T) {
	...
	check := SystemdCheck{stats: stats}
	senderManager := mocksender.CreateDefaultDemultiplexer()
	check.Configure(senderManager, handler.NewMockCheckManager(), integration.FakeConfigHash, []byte(``), []byte(``), "test", "provider")
...
`)
	check := SystemdCheck{stats: stats}
	senderManager := mocksender.CreateDefaultDemultiplexer()
	check.Configure(senderManager, handler.NewMockCheckManager(), integration.FakeConfigHash, rawInstanceConfig, nil, "test", "provider")
...
`)
	...
	check := SystemdCheck{stats: stats}
	senderManager := mocksender.CreateDefaultDemultiplexer()
	check.Configure(senderManager, handler.NewMockCheckManager(), integration.FakeConfigHash, rawInstanceConfig, integration.Data{}, "test", "provider")
...
`)
	...
	check := SystemdCheck{}
	check.Configure(aggregator.NewNoOpSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, rawInstanceConfig, nil, "test", "provider")
...
`)
	...
	systemdCheck.Configure(mockSender.GetSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, rawInstanceConfig, nil, "test", "provider")
	// run
	systemdCheck.Run()
