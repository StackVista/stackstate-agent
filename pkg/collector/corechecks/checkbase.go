...
func (c *CheckBase) Configure(senderManager sender.SenderManager, checkManager handler.CheckManager, _ uint64, data integration.Data, initConfig integration.Data, source string, provider string) error {
...
func (c *CheckBase) CommonConfigure(senderManager sender.SenderManager, checkManager handler.CheckManager, initConfig, instanceConfig integration.Data, source string, provider string) error {
	c.senderManager = senderManager
