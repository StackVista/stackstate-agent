...
func TestNano(t *testing.T) {
	...
	tegraCheck.Configure(mock.GetSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, integration.Data{}, integration.Data{}, "test", "provider")
...
`, tt.path)
			...
			err := tegraCheck.Configure(mock.GetSenderManager(), handler.NewMockCheckManager(), integration.FakeConfigHash, integration.Data(instanceConfig), nil, "test", "provider")
