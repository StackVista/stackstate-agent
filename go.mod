...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/agenttelemetry/def v0.78.3-rc.2
	github.com/DataDog/datadog-agent/comp/core/agenttelemetry/fx v0.78.3-rc.2
	github.com/DataDog/datadog-agent/comp/core/config v0.78.3-rc.2
	github.com/DataDog/datadog-agent/comp/core/configsync v0.78.3-rc.2
	...
	github.com/DataDog/datadog-agent/comp/core/ipc/impl v0.78.3-rc.2
	...
	github.com/DataDog/datadog-agent/comp/core/log/impl-trace v0.78.3-rc.2
	...
	github.com/DataDog/datadog-agent/comp/core/secrets/fx v0.78.3-rc.2
	github.com/DataDog/datadog-agent/comp/core/secrets/mock v0.78.3-rc.2
	...
	github.com/DataDog/datadog-agent/comp/core/status/statusimpl v0.78.3-rc.2
	...
	github.com/DataDog/datadog-agent/comp/core/tagger/impl-remote v0.78.3-rc.2
	github.com/DataDog/datadog-agent/comp/core/tagger/origindetection v0.78.3-rc.2
	github.com/DataDog/datadog-agent/comp/core/tagger/subscriber v0.78.3-rc.2
	...
	github.com/DataDog/datadog-agent/comp/otelcol/ddprofilingextension/def v0.78.3-rc.2
	...
	github.com/DataDog/datadog-agent/comp/otelcol/status/impl v0.78.3-rc.2
	...
	github.com/DataDog/datadog-agent/pkg/collector/check/defaults v0.78.3-rc.2
	...
	github.com/DataDog/datadog-agent/pkg/config/remote v0.78.3-rc.2
	...
	github.com/DataDog/datadog-agent/pkg/logs/util/testutils v0.78.3-rc.2
	github.com/DataDog/datadog-agent/pkg/metrics v0.78.3-rc.2
	github.com/DataDog/datadog-agent/pkg/network/driver v0.78.3-rc.2
	github.com/DataDog/datadog-agent/pkg/network/payload v0.78.3-rc.2
	github.com/DataDog/datadog-agent/pkg/networkdevice/profile v0.78.3-rc.2
	...
	github.com/DataDog/datadog-agent/pkg/security/secl v0.78.3-rc.2
	github.com/DataDog/datadog-agent/pkg/security/seclwin v0.78.3-rc.2
	github.com/DataDog/datadog-agent/pkg/status/health v0.78.3-rc.2
	...
	github.com/DataDog/datadog-agent/pkg/util/containers/image v0.78.3-rc.2
	github.com/DataDog/datadog-agent/pkg/util/defaultpaths v0.78.3-rc.2
	github.com/DataDog/datadog-agent/pkg/util/executable v0.78.3-rc.2
	...
	github.com/DataDog/datadog-agent/pkg/util/hostinfo v0.78.3-rc.2
	github.com/DataDog/datadog-agent/pkg/util/hostname/validate v0.78.3-rc.2
	github.com/DataDog/datadog-agent/pkg/util/http v0.78.3-rc.2
	github.com/DataDog/datadog-agent/pkg/util/json v0.78.3-rc.2
	github.com/DataDog/datadog-agent/pkg/util/jsonquery v0.78.3-rc.2
	...
	github.com/DataDog/datadog-agent/pkg/util/utilizationtracker v0.78.3-rc.2
...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/agenttelemetry/impl v0.78.3-rc.2 // indirect
	github.com/DataDog/datadog-agent/comp/core/secrets/impl v0.78.3-rc.2 // indirect
...
require (
	...
	github.com/DataDog/datadog-agent/comp/logs-library v0.78.3-rc.2
	github.com/DataDog/datadog-agent/comp/otelcol/collector-contrib/impl v0.78.3-rc.2
	github.com/DataDog/datadog-agent/comp/otelcol/ddflareextension/impl v0.78.3-rc.2
	github.com/DataDog/datadog-agent/comp/otelcol/ddprofilingextension/impl v0.78.3-rc.2
	github.com/DataDog/datadog-agent/comp/otelcol/logsagentpipeline v0.78.3-rc.2
	github.com/DataDog/datadog-agent/comp/otelcol/logsagentpipeline/logsagentpipelineimpl v0.78.3-rc.2
	...
	github.com/DataDog/datadog-agent/pkg/util/kubernetes/apiserver/common/namespace v0.78.3-rc.2
...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/delegatedauth/api/cloudauth/aws v0.78.3-rc.2 // indirect
	...
	github.com/DataDog/datadog-agent/pkg/util/aws/creds v0.78.3-rc.2 // indirect
...
// go-openapi/testify/v2 removed assert/yaml after v2.0.2; go-openapi/swag/loading
// test deps still import it via testify/enable/yaml/v2.
