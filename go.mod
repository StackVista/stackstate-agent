...
require (
	...
	github.com/DataDog/datadog-agent/pkg/util/log v0.33.0-rc.7
	github.com/DataDog/datadog-agent/pkg/util/scrubber v0.33.0-rc.7
	github.com/DataDog/datadog-agent/pkg/util/winutil v0.33.0-rc.7
