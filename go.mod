...
require (
	...
	github.com/DataDog/datadog-agent/pkg/otlp/model v0.32.0-rc.4
	github.com/DataDog/datadog-agent/pkg/quantile v0.32.0-rc.4
	github.com/DataDog/datadog-agent/pkg/util/log v0.32.0-rc.4
	github.com/DataDog/datadog-agent/pkg/util/winutil v0.32.0-rc.4
